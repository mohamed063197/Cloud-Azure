...
# 1. AZ-900
## Definition
le cloud computing modifie la planification de l'infrastructure des cycles d'approvisionnement longs jusqu'a l'approvisionnement a la demande.
## Introduction
...
<div style="text-align: center;">
  <img src="shared-responsibility-model.png" alt="Services types" width="800" style="max-width: 100%; height: auto;">
</div>
